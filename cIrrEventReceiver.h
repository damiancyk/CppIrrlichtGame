...
public:
    ...
    inline int getLastMouseX()
    {
        return MouseData.lx;
    }

    inline int getLastMouseY()
    {
        return MouseData.ly;
    }
    ...
    inline u32 getClickedMouseX()
    {
        return MouseData.cx;
    }

    inline u32 getClickedMouseY()
    {
        return MouseData.cy;
    }

    inline f32 getMouseWheelPosition()
    {
        return MouseData.wheelPos;
    }

    inline f32 getLastMouseWheelPosition()
    {
